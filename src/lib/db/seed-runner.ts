...
export async function seedDatabase(): Promise<void> {
  ...
  const rituals = [
    { name: "Tilak", description: "The formal acceptance ceremony where bride's father applies tilak on groom's forehead in the presence of both families. Marks the official beginning of wedding proceedings.", requiredItems: ["Chandan (sandalwood paste)", "Kumkum (vermilion)", "Akshat (whole unbroken rice grains)", "Marigold flowers", "Supari (betel nut)", "Coconut", "Dakshina (cash gift)", "Pedha/Laddu (sweets)", "Pan leaves (5 pairs)", "Sindoor", "New dhoti-kurta for groom", "Mango leaves"], responsiblePerson: "Bride's Father (Kanyadaan Pita)", budget: 25000, scheduledDate: new Date("2026-11-10"), scheduledTime: "10:00", priestNotes: "Muhurat: 10:00–12:00. Priest will guide the rituals. Keep all items ready in a thali." },
    { name: "Matkor (Mitti Puja)", description: "Sacred earth-worship ritual performed the night before the wedding. Soil from five auspicious places is collected and worshipped. Symbolises grounding and blessings from Mother Earth.", requiredItems: ["Sacred soil from 5 places (well, temple, anthill, river bank, crossroads)", "5 clay pots (matka)", "Mango leaves", "Marigold flowers", "5 earthen diyas (lamps)", "Mustard oil (for diyas)", "Incense sticks (agarbatti)", "Turmeric paste", "Sindoor", "Coins (5 types)", "Red cloth", "White rice"], responsiblePerson: "Elder Women of Family (Mamijaan / Chachi)", budget: 10000, scheduledDate: new Date("2026-11-24"), scheduledTime: "20:00", priestNotes: "Ladies-only ritual. Performed after sunset. Song 'Matkor ki geet' sung by ladies." },
    { name: "Haldi (Ubtan) Ceremony", description: "Turmeric paste ceremony to purify and beautify the groom before the wedding. Paste is applied by female relatives with songs and blessings.", requiredItems: ["Haldi (turmeric powder)", "Chandan (sandalwood paste)", "Besan (gram flour)", "Malai (cream)", "Rose water", "Mustard oil", "Fresh neem leaves (anti-bacterial)", "Marigold flowers for decoration", "Banana leaves (for base)", "Yellow cloth/dupatta", "Yellow outfit for groom", "Bowl for ubtan preparation"], responsiblePerson: "Groom's Maternal Aunt (Maasi / Buaa)", budget: 20000, scheduledDate: new Date("2026-11-23"), scheduledTime: "09:00", priestNotes: "Groom should not step outside after haldi till wedding. Keep a clean change of clothes ready." },
    { name: "Jaimala (Varmala)", description: "The garland exchange ceremony where bride and groom exchange flower garlands accepting each other as life partners. Playful ritual where families try to lift each person to prevent the garland from reaching.", requiredItems: ["2 fresh flower garlands (marigold + rose + mogra – one each)", "Flower petals for showering", "Supari (betel nut) in small thali", "Coconut", "Rose water spray", "Background music arrangement", "Stage decoration"], responsiblePerson: "Master of Ceremony / Event Coordinator", budget: 8000, scheduledDate: new Date("2026-11-25"), scheduledTime: "19:30", priestNotes: "Garlands should be fresh, not wilted. Order day-of from flower vendor." },
    { name: "Kanyadaan", description: "The most sacred and emotional ritual where the bride's father gives away his daughter's hand to the groom. The ultimate gift (dan) that a father can give. Bride's parents place her hands in groom's hands.", requiredItems: ["Kalash (copper/silver pot) filled with Ganga water", "Mango leaves in kalash", "Coconut on kalash", "Gold coin or gold ornament", "Honey (madhu)", "Ghee (clarified butter)", "Flowers (lotus if possible)", "Sacred thread (mauli/kalawa)", "Akshat (whole rice)", "White handkerchief/cloth", "Groom's ring"], responsiblePerson: "Bride's Father + Priest (Pt. Ramakant Shastri)", budget: 5000, scheduledDate: new Date("2026-11-25"), scheduledTime: "21:00", priestNotes: "Most emotional ritual. Have tissues ready. Photographer must capture this moment. Priest will recite mantras." },
    { name: "Saat Phere (Saptapadi)", description: "The seven sacred rounds around the holy fire, each representing a vow of marriage. The most binding ritual of Hindu marriage. After the 7th round, the couple are legally and spiritually married.", requiredItems: ["Sacred fire / Agni kund (havan kund)", "Dry mango wood (aam ki lakdi)", "Samidha (small pieces of wood for havan)", "Ghee (3 kg at least)", "Havishya materials: sesame (til), rice (chawal), barley (jau), dry coconut, camphor", "Banana leaves (2 large)", "Akshat", "Flowers", "Incense sticks", "Sacred thread connecting bride and groom", "Cotton wicks for agni", "Earthen pot for havan"], responsiblePerson: "Pt. Ramakant Shastri (Head Priest)", budget: 15000, scheduledDate: new Date("2026-11-25"), scheduledTime: "21:30", priestNotes: "7 rounds in total. Each round = 1 vow. Bride leads for first 3, groom leads for last 4 (varies by tradition). Total time ~45 minutes." },
    { name: "Sindoor Daan", description: "The groom applies sindoor (vermilion) in the parting of the bride's hair, officially making her his wife. The most visible sign of a married Hindu woman.", requiredItems: ["Sindoor (vermilion) – preferably in a gold box", "Gold ring or coin to apply sindoor (not bare finger)", "Small mirror for bride", "Flowers", "Akshat (whole rice)", "Mangalsutra (if being tied at this time)", "Bangles (chura/shakha-pola per tradition)"], responsiblePerson: "Groom (assisted by Priest)", budget: 3000, scheduledDate: new Date("2026-11-25"), scheduledTime: "22:30", priestNotes: "Apply sindoor with ring/coin from groom's right hand. Priest will guide exact procedure." },
    { name: "Vidaai (Bride's Farewell)", description: "The emotional farewell ceremony where the bride leaves her parental home for the last time as an unmarried daughter. She throws puffed rice over her head three times as a blessing to her parents.", requiredItems: ["Puffed rice / laaja (lawa) – 3 handfuls", "Flowers for showering", "Coconut (bride kicks before leaving)", "Dahi and honey (for good omen)", "New saree for bride to change into", "Mangalsutra (if not applied earlier)", "Decorated car for departure", "Diyas on both sides of the door"], responsiblePerson: "Both Families + Event Coordinator", budget: 10000, scheduledDate: new Date("2026-11-25"), scheduledTime: "23:45", priestNotes: "Bride must not look back. Groom's family receives her. Have water/juice ready. Photographer MUST capture this." },
    { name: "Griha Pravesh (Home Welcome)", description: "The welcoming of the new bride into the groom's home. She kicks a pot of rice with her right foot (symbolising prosperity), then enters right foot first.", requiredItems: ["Decorated kalash at doorstep", "Rice/wheat pot for bride to kick (right foot)", "Red colour (alta) for bride's feet", "Flower petals for path", "Diya and aarti plate", "Sweets (kheer or halwa)", "Red cloth at threshold", "Mango leaves and marigold door decoration", "Coconut"], responsiblePerson: "Groom's Mother", budget: 8000, scheduledDate: new Date("2026-11-26"), scheduledTime: "06:00", priestNotes: "Must happen before sunrise (muhurat). Groom's mother does aarti. Bride enters right foot first." },
  ]
  ...
  await prisma.alert.upsert({ where: { id: "alert-budget-overrun" }, update: {}, create: { id: "alert-budget-overrun", weddingId: wedding.id, type: "WARNING", title: "Budget Overrun Alert", message: "One or more budget categories have exceeded planned amounts. Review Finance section.", active: true, threshold: 90 } })
  await prisma.alert.upsert({ where: { id: "alert-rsvp-pending" }, update: {}, create: { id: "alert-rsvp-pending", weddingId: wedding.id, type: "INFO", title: "RSVP Confirmations Pending", message: "Several guests have not confirmed attendance. Send RSVP reminder via WhatsApp.", active: true } })
  await prisma.alert.upsert({ where: { id: "alert-vendor-payment" }, update: {}, create: { id: "alert-vendor-payment", weddingId: wedding.id, type: "WARNING", title: "Vendor Advance Payments Due", message: "Photography and catering vendors have advance payment deadlines approaching.", active: true } })
}
