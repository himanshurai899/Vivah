...
async function main() {
  console.log("ðŸŒ± Seeding Vivah database...")
  ...
  console.log(`âœ… Wedding created: ${wedding.id}`)
  console.log(`\nâš¡ Add to .env.local:\nWEDDING_ID="${wedding.id}"\n`)

  // â”€â”€ Wedding Functions / Events â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const events = [
    ...
    { name: "Sangeet Night", eventType: "WEDDING", date: new Date("2026-11-23"), venue: "Banyan Paradise Resort â€” Jasmine Hall", startTime: "19:00", endTime: "23:00", coordinator: "Rohit Singh", budget: 200000, notes: "DJ night, dance performances by families, live music. Both families perform." },
    ...
    { name: "Jaimala", eventType: "WEDDING", date: new Date("2026-11-25"), venue: "Banyan Paradise Resort â€” Mandap", startTime: "19:30", endTime: "20:00", coordinator: "Master of Ceremony", budget: 10000, notes: "Garland exchange between bride and groom. Families try to lift each person." },
    { name: "Mandap Ceremony", eventType: "WEDDING", date: new Date("2026-11-25"), venue: "Banyan Paradise Resort â€” Mandap", startTime: "20:00", endTime: "23:30", coordinator: "Pt. Ramakant Shastri", budget: 51000, notes: "Main wedding ceremony with priest. Includes Kanyadaan, Saat Phere, Sindoor Daan." },
    { name: "Kanyadaan", eventType: "WEDDING", date: new Date("2026-11-25"), venue: "Banyan Paradise Resort â€” Mandap", startTime: "21:00", endTime: "21:30", coordinator: "Pt. Ramakant Shastri", budget: 5000, notes: "Father gives away bride. Most emotional ritual. Bride's parents give her hand to groom." },
    { name: "Saat Phere", eventType: "WEDDING", date: new Date("2026-11-25"), venue: "Banyan Paradise Resort â€” Mandap", startTime: "21:30", endTime: "22:30", coordinator: "Pt. Ramakant Shastri", budget: 0, notes: "Seven rounds around sacred fire. Each round represents one vow of marriage." },
    { name: "Sindoor Daan", eventType: "WEDDING", date: new Date("2026-11-25"), venue: "Banyan Paradise Resort â€” Mandap", startTime: "22:30", endTime: "22:45", coordinator: "Pt. Ramakant Shastri", budget: 2000, notes: "Groom applies sindoor in bride's maang. Marks her as married." },
    { name: "Vidaai", eventType: "WEDDING", date: new Date("2026-11-25"), venue: "Banyan Paradise Resort â€” Gate", startTime: "23:45", endTime: "00:30", coordinator: "Both Families", budget: 20000, notes: "Bride's farewell. She throws puffed rice over her head three times. Very emotional." },
    ...
    { name: "Reception", eventType: "POST_WEDDING", date: new Date("2026-11-26"), venue: "Banyan Paradise Resort â€” Main Lawn", startTime: "18:00", endTime: "23:00", coordinator: "Event Management Team", budget: 300000, notes: "Grand reception. All guests invited. Dinner, DJ, couple on stage for photo sessions." },
    ...
    { name: "Family Lunch", eventType: "POST_WEDDING", date: new Date("2026-11-27"), venue: "Banyan Paradise Resort â€” Dining Hall", startTime: "13:00", endTime: "16:00", coordinator: "Priya Devi", budget: 50000, notes: "Farewell lunch for all guests before they depart. Bihari cuisine served." },
  ]
  ...
  console.log(`âœ… ${events.length} events/functions seeded`)

  // â”€â”€ Bihari Wedding Rituals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const rituals = [
    {
      name: "Tilak",
      ...
      requiredItems: ["Chandan (sandalwood paste)", "Kumkum (vermilion)", "Akshat (whole unbroken rice grains)", "Marigold flowers", "Supari (betel nut)", "Coconut", "Dakshina (cash gift)", "Pedha/Laddu (sweets)", "Pan leaves (5 pairs)", "Sindoor", "New dhoti-kurta for groom", "Mango leaves"],
      responsiblePerson: "Bride's Father (Kanyadaan Pita)",
      budget: 25000,
      scheduledDate: new Date("2026-11-10"),
      scheduledTime: "10:00",
      priestNotes: "Muhurat: 10:00â€“12:00. Priest will guide the rituals. Keep all items ready in a thali.",
    },
    {
      ...
      requiredItems: ["Sacred soil from 5 places (well, temple, anthill, river bank, crossroads)", "5 clay pots (matka)", "Mango leaves", "Marigold flowers", "5 earthen diyas (lamps)", "Mustard oil (for diyas)", "Incense sticks (agarbatti)", "Turmeric paste", "Sindoor", "Coins (5 types)", "Red cloth", "White rice"],
    ...
    },
    {
      ...
      requiredItems: ["Haldi (turmeric powder)", "Chandan (sandalwood paste)", "Besan (gram flour)", "Malai (cream)", "Rose water", "Mustard oil", "Fresh neem leaves (anti-bacterial)", "Marigold flowers for decoration", "Banana leaves (for base)", "Yellow cloth/dupatta", "Yellow outfit for groom", "Bowl for ubtan preparation"],
    ...
    },
    {
      ...
      requiredItems: ["2 fresh flower garlands (marigold + rose + mogra â€” one each)", "Flower petals for showering", "Supari (betel nut) in small thali", "Coconut", "Rose water spray", "Background music arrangement", "Stage decoration"],
    ...
    },
    {
      ...
      requiredItems: ["Kalash (copper/silver pot) filled with Ganga water", "Mango leaves in kalash", "Coconut on kalash", "Gold coin or gold ornament", "Honey (madhu)", "Ghee (clarified butter)", "Flowers (lotus if possible)", "Sacred thread (mauli/kalawa)", "Akshat (whole rice)", "White handkerchief/cloth", "Groom's ring"],
    ...
    },
    {
      ...
      requiredItems: ["Sindoor (vermilion) â€” preferably in a gold box", "Gold ring or coin to apply sindoor (not bare finger)", "Small mirror for bride", "Flowers", "Akshat (whole rice)", "Mangalsutra (if being tied at this time)", "Bangles (chura/shakha-pola per tradition)"],
    ...
    },
    {
      ...
      requiredItems: ["Puffed rice / laaja (lawa) â€” 3 handfuls", "Flowers for showering", "Coconut (bride kicks before leaving)", "Dahi and honey (for good omen)", "New saree for bride to change into", "Mangalsutra (if not applied earlier)", "Decorated car for departure", "Diyas on both sides of the door"],
    ...
    },
    {
      ...
      requiredItems: ["Decorated kalash at doorstep", "Rice/wheat pot for bride to kick (right foot)", "Red colour (alta) for bride's feet", "Flower petals for path", "Diya and aarti plate", "Sweets (kheer or halwa)", "Red cloth at threshold", "Mango leaves and marigold door decoration", "Coconut"],
  ...
  console.log(`âœ… ${rituals.length} Bihari rituals seeded with full samagri lists`)

  // â”€â”€ Vendors â€” Vadodara (from web search) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const vendors = [
    { name: "VMR Photography", category: "PHOTOGRAPHER", phone: "+91 94XXXXXXXX", contactPerson: "VMR", quotation: 90000, negotiatedAmount: 80000, status: "SHORTLISTED", rating: 5, notes: "â‚¹30,000/day Ã— 3 days. 4.9 rating, 18 reviews on WedMeGood. Candid + traditional." },
    { name: "The Wedding Scenario", category: "PHOTOGRAPHER", phone: "+91 98XXXXXXXX", contactPerson: "Manager", quotation: 105000, negotiatedAmount: 95000, status: "SHORTLISTED", rating: 5, notes: "â‚¹35,000/day Ã— 3 days. 5.0 rating, 16 reviews. Award-winning team." },
    { name: "Keyur Soni Photography", category: "PHOTOGRAPHER", phone: "+91 90XXXXXXXX", contactPerson: "Keyur Soni", quotation: 120000, negotiatedAmount: 110000, status: "SHORTLISTED", rating: 5, notes: "â‚¹40,000/day Ã— 3 days. 5.0 rating, 34 reviews. Drone photography available (â‚¹10,000 extra)." },
    { name: "Rajpurohit Caterers", category: "CATERER", phone: "+91 97XXXXXXXX", contactPerson: "Rajesh Purohit", quotation: 800 * 110, negotiatedAmount: 800 * 100, status: "SHORTLISTED", rating: 4, notes: "â‚¹110/plate veg. Capacity: 1000+ guests. Pure veg. Bihari + Gujarati menu available." },
    { name: "Desai Caterers Vadodara", category: "CATERER", phone: "+91 98XXXXXXXX", contactPerson: "Kiran Desai", quotation: 800 * 400, negotiatedAmount: 800 * 350, status: "SHORTLISTED", rating: 4, notes: "â‚¹400/plate veg. Premium catering with multiple cuisine options including Bihari thali." },
    { name: "Munch Catering Services", category: "CATERER", phone: "+91 93XXXXXXXX", contactPerson: "Ramesh Shah", quotation: 800 * 200, negotiatedAmount: 800 * 175, status: "SHORTLISTED", rating: 4, notes: "â‚¹175/plate. Good reputation for North Indian food. Can arrange Bihari special items." },
    { name: "H.R. Creation Diwalipura", category: "DECORATOR", phone: "+91 99XXXXXXXX", contactPerson: "Hitesh", quotation: 120000, negotiatedAmount: 100000, status: "SHORTLISTED", rating: 5, notes: "Starting â‚¹80,000. 5.0 rating. Specialises in mandap + floral decoration." },
    { name: "AK Creation Decoration", category: "DECORATOR", phone: "+91 92XXXXXXXX", contactPerson: "Akash", quotation: 100000, negotiatedAmount: 90000, status: "SHORTLISTED", rating: 4, notes: "Starting â‚¹80,000. Traditional and contemporary wedding decoration." },
    { name: "Folk Finds Decor", category: "DECORATOR", phone: "+91 87XXXXXXXX", contactPerson: "Manager", quotation: 250000, negotiatedAmount: 220000, status: "SHORTLISTED", rating: 5, notes: "Premium decor starting â‚¹2,00,000. Specialises in grand wedding themes." },
    ...
    { name: "DJ Anand Entertainment", category: "DJ", phone: "+91 90XXXXXXXX", contactPerson: "Anand", quotation: 30000, negotiatedAmount: 25000, status: "SHORTLISTED", rating: 4, notes: "â‚¹25,000 for full night. Bollywood + Bhojpuri songs. Sound system included." },
  ...
  console.log(`âœ… ${vendors.length} Vadodara vendors seeded`)

  // â”€â”€ Budget Categories â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  console.log(`âœ… ${budgetCategories.length} budget categories seeded`)

  // â”€â”€ Hotels / Accommodation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const hotels = [
  ...
  console.log(`âœ… ${hotels.length} hotels seeded`)
  ...
  const tasks = [
    { name: "Confirm wedding venue â€” Banyan Paradise Resort", priority: "CRITICAL", status: "COMPLETED", owner: "Suresh Kumar", deadline: new Date("2026-04-01"), notes: "Venue confirmed and deposit paid." },
    ...
    { name: "Confirm priest (Pandit) â€” Pt. Ramakant Shastri", priority: "CRITICAL", status: "COMPLETED", owner: "Suresh Kumar", notes: "Booked and confirmed. Advance paid." },
    { name: "Plan Mehendi ceremony â€” artist and guest list", priority: "MEDIUM", status: "PENDING", owner: "Sunita Verma", deadline: new Date("2026-10-01") },
  ...
  // â”€â”€ Family Responsibilities â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const responsibilities = [
    ...
    { task: "Vendor Payments & Receipts", owner: "Suresh Kumar (Father)", backupPerson: "Deepak Singh (Uncle)", priority: "CRITICAL", status: "PENDING", notes: "Keep all vendor payment records. Carry cheque book + UPI. No cash payments over â‚¹10,000.", deadline: new Date("2026-11-20") },
    ...
    { task: "Baraat Coordination", owner: "Rajesh Kumar (Uncle â€” Mama)", backupPerson: "Arvind Sharma", priority: "HIGH", status: "PENDING", notes: "Lead the baraat procession. Coordinate with band. Groom's decorated horse/car ready.", deadline: new Date("2026-11-25") },
    ...
    { task: "Medical & Emergency Preparedness", owner: "Dr. Rajesh (Family Doctor)", backupPerson: "Rahul Kumar", priority: "HIGH", status: "PENDING", notes: "First aid kit at venue. Hospital contact list. Emergency contact sheet printed Ã— 20.", deadline: new Date("2026-11-24") },
  ]
  ...
  console.log(`âœ… ${responsibilities.length} family responsibilities seeded`)

  // â”€â”€ WhatsApp Templates â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const templates = [
    { name: "Wedding Invitation â€” Formal", category: "INVITATION", variables: ["GuestName", "FunctionName", "Date", "Venue"], message: "ðŸ™ *Vivah Nimantran*\n\nNamaskar {{GuestName}} ji,\n\nHumein yeh sunate hue atyant prasannata ho rahi hai ki hamari parivaar mein shaadi ka shubh avsar aa raha hai.\n\n*{{FunctionName}}*\nðŸ“… {{Date}}\nðŸ“ {{Venue}}\n\nAapka saparivaar swagat hai.\n\nâ€” Suresh Kumar Parivar" },
    { name: "RSVP Confirmation Request", category: "REMINDER", variables: ["GuestName", "DeadlineDate"], message: "Namaskar {{GuestName}} ji ðŸ™\n\nHumne aapko wedding card bheja tha. Kripya apni attendance confirm karein taaki hum proper arrangements kar sakein.\n\nâœ… Confirm karne ke liye reply mein *HAAN* likhein\nâŒ Nahi aane ke liye *NAHI* likhein\n\nDeadline: {{DeadlineDate}}\n\nDhanyavaad! ðŸŒ¸" },
    { name: "Travel & Arrival Details", category: "TRAVEL_UPDATE", variables: ["GuestName", "ArrivalDate", "PickupTime", "CoordinatorName", "CoordinatorPhone"], message: "Namaskar {{GuestName}} ji ðŸ™\n\nAapke swagat ki poori taiyari hai!\n\nâœˆï¸ *Travel Info*\nArrival: {{ArrivalDate}}\nPickup: {{PickupTime}}\n\nðŸš— *Pickup Coordinator*\n{{CoordinatorName}}: {{CoordinatorPhone}}\n\nStation par aate hi call karein. Gaadi ready rahegi.\n\nâ€” Wedding Team" },
    { name: "Hotel Accommodation Confirmation", category: "CONFIRMATION", variables: ["GuestName", "HotelName", "RoomNumber", "CheckIn", "CheckOut"], message: "Namaskar {{GuestName}} ji ðŸ™\n\n*Accommodation Confirmed* ðŸ¨\n\nHotel: {{HotelName}}\nRoom: {{RoomNumber}}\nCheck-in: {{CheckIn}}\nCheck-out: {{CheckOut}}\n\nKoi problem ho to seedha call karein:\nHotel Coordinator: +91-XXXXXXXXXX\n\nWedding Team" },
    { name: "Wedding Day Reminder", category: "REMINDER", variables: ["GuestName", "FunctionName", "Time", "Venue"], message: "ðŸŽŠ *Kal hai shaadi!*\n\nNamaskar {{GuestName}} ji,\n\nKal ka din bohot khaas hai! Aapko yaad dilana chahte hain:\n\n*{{FunctionName}}*\nðŸ• {{Time}}\nðŸ“ {{Venue}}\n\nSamay par pahuchen. Aapka intzaar rahega! ðŸŒ¹\n\nâ€” Vivah Team" },
    { name: "Mehendi Invitation", category: "INVITATION", variables: ["GuestName", "Date", "Time", "Venue"], message: "ðŸ’š *Mehendi ka Nimantran*\n\nNamaskar {{GuestName}} ji,\n\nAapko sadar nimantran hai:\n\n*Mehendi Ceremony*\nðŸ“… {{Date}}\nðŸ• {{Time}}\nðŸ“ {{Venue}}\n\nMehendi lagwana bilkul free hai sabke liye! Sundar rang layein ðŸ’š\n\nâ€” Vivah Team" },
    { name: "Sangeet Night Invitation", category: "INVITATION", variables: ["GuestName", "Date", "Time", "Venue"], message: "ðŸŽµ *Sangeet Night*\n\nNamaskar {{GuestName}} ji,\n\nGaane, naachne aur dhoom machane ka waqt aa gaya!\n\n*Sangeet Night*\nðŸ“… {{Date}}\nðŸ• {{Time}}\nðŸ“ {{Venue}}\n\nApni best performance ready rakhein! ðŸŽ¤ðŸ’ƒ\n\nâ€” Vivah Team" },
    { name: "Post Wedding Thank You", category: "GENERAL", variables: ["GuestName"], message: "ðŸ™ *Heartfelt Thanks*\n\nNamaskar {{GuestName}} ji,\n\nAapka humari wedding mein tashreef lane ke liye bahut bahut dhanyavaad! Aapki uplabdhata ne is pal ko aur khaas bana diya.\n\nAapke pyaar aur aashirwaad ke liye hamesha aaabhari rahenge. ðŸŒ¸\n\nâ€” Himanshu & Samiksha" },
  ]
  ...
  console.log(`âœ… ${templates.length} WhatsApp templates seeded`)

  // â”€â”€ Invitation Blocks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const invitationBlocks = [
    { section: "HEADER", title: "Wedding Invitation", primaryText: "ðŸŒ¸ Shubh Vivah ðŸŒ¸", description: "With great joy and divine blessings, we invite you to celebrate the sacred union of our beloved children", sortOrder: 1 },
    ...
    { section: "EVENT", title: "Reception Evening", date: new Date("2026-11-26"), time: "6:00 PM â€“ 11:00 PM", primaryText: "PURSHOTTAM PARTY PLOT â€” Main Lawn", description: "Dinner | DJ | Photography | Couple on Stage", sortOrder: 6 },
    { section: "FOOTER", title: "Contact Us", primaryText: "Wedding Coordination", contact: "Suresh Kumar: +91-XXXXXXXXXX\nRahul Kumar: +91-XXXXXXXXXX\nWedding Helpline: +91-XXXXXXXXXX", description: "For any queries, accommodation bookings, or travel assistance â€” please reach out to us. We are happy to help!", sortOrder: 7 },
  ]
  ...
  console.log(`âœ… ${invitationBlocks.length} invitation blocks seeded`)
  ...
  console.log("âœ… 3 default alerts seeded")

  console.log("\nðŸŽŠ Database seeded successfully!")
  console.log(`\nðŸ’¡ Next steps:`)
