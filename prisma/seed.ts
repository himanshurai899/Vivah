...
async function main() {
  ...
  const events = [
    { name: "Tilak Ceremony", eventType: "PRE_WEDDING", date: new Date("2026-11-10"), venue: "Bride's Residence", startTime: "10:00", endTime: "13:00", coordinator: "Suresh Kumar", budget: 50000, notes: "Groom's family visits bride's family. Tilak applied by bride's father on groom's forehead." },
    ...
    { name: "Baraat", eventType: "WEDDING", date: new Date("2026-11-25"), venue: "Starts from Hotel, arrives at Banyan Paradise Resort", startTime: "17:00", endTime: "19:00", coordinator: "Rajesh Kumar (Groom's Uncle)", budget: 100000, notes: "Groom's procession. Band, DJ, dancing. Decorated horse/car for groom." },
